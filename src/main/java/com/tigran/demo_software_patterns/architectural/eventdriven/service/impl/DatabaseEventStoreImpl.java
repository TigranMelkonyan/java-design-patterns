...
import com.tigran.demo_software_patterns.architectural.eventdriven.service.DatabaseEventStore;
 ...
 */
@Service
public class DatabaseEventStoreImpl implements DatabaseEventStore {

    private final EventStoreRepository eventRepository;

    public DatabaseEventStoreImpl(EventStoreRepository eventRepository) {
